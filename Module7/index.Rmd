...
Afin de faciliter le téléchargement de ces données, l'ensemble de ces couches d'informations spatiales peuvent être téléchargées en cliquant sur un seul lien: [données pour le module 7](https://github.com/sci1031/data/raw/main/Module7_donnees.zip). 
...
La distance calculée est de `r as.integer(distance_lapoc_rimou[1])`&nbsp;m, soit environ `r as.integer(round(distance_lapoc_rimou[1]/1000))` km. Notez que nous avons calculé la distance géométrique et non la distance que l'odomètre d'une voiture calculerait en voyageant sur l'autoroute entre La Pocatière et Rimouski. 
